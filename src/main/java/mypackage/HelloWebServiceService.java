 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://demo.webservices.com/", wsdlLocation = "http://localhost:1531/service/helloWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://demo.webservices.com/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1531/service/helloWebService?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://demo.webservices.com/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.webservices.com/", "HelloWebServicePort"), HelloWebService.class, features);
    }
